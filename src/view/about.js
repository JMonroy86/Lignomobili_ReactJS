...
const About = (props) => {
    return (
        <>
            <Carousel routeUrl={CarouselList.about} carouselVal="0"  />
            <section id="about">
                <div className="container pt-5 pb-5">
                    <div className="row">
                        <div className="col-sm-12 text-center">
                            <img src="img/logo_slogan.png" className="img-fluid" alt="" />
                        </div>
                        <div className="col-sm-12 col-md-12 col-lg-12 pt-5">
                            <h3 className="display-4">¿Quienes somos?</h3>
                            <p className="text h5 text-justify pt-3">LIGNO MOBILI somos una marca respaldada por una sociedad
                            ...
                            <p className="text h5 text-justify pt-3">En Chile, tenemos para manufactura una planta física en el área
                            ...
                            <p className="text h5 text-justify pt-3">Contamos con un equipo de trabajo multidisciplinarios
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-12 pt-5">
                            <h3 className="display-4">Misión</h3>
                            <p className="text h5 text-justify">Proveer productos y servicios de alta calidad a los distintos
                            sectores económicos del país, con tiempos de respuesta oportunos y que satisfagan las necesidades
                                    de los Clientes.</p>
                        </div>
                        <div className="col-sm-12 col-md-12 col-lg-12 pt-5">
                            <h3 className="display-4">Visión</h3>
                            <p className="text h5 text-justify">Convertirnos en líderes en la fabricación de muebles en
